...
run:
	...
	PROJECT_ROOT='${PROJECT_ROOT}' DEVICE_TYPE=${DEVICE_TYPE} bash ~/bin/titanium
...
deploy:
	...
	@mkdir -p '${PROJECT_ROOT}/${PROJECT_NAME}/build/iphone/'
	@mkdir -p '${PROJECT_ROOT}/${PROJECT_NAME}/build/android/'
	PROJECT_ROOT='${PROJECT_ROOT}' DEVICE_TYPE=${DEVICE_TYPE} BUILD_TYPE='device' bash ~/bin/titanium
